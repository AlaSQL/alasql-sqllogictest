...
```sql
SELECT * FROM tab2 WHERE NOT + - 21 IN ( - 67 * + col0 / - + col0 * + CAST ( 97 AS INTEGER ) )
...
```sql
SELECT COUNT ( * ) FROM tab2 WHERE ( NOT + 4 / - + col0 < NULL )
...
Expected: ["1","17","3"] but got ["1.936","17","3.643"]
```
...
```sql
SELECT + - COUNT ( * ) / + - 23 FROM tab0 AS cor0 CROSS JOIN tab0 AS cor1

Expected: ["0"] but got ["0.391"]
```
...
```sql
SELECT COUNT ( * ) * - 2 / 65 AS col0 FROM tab2

Expected: ["0"] but got ["-0.092"]
```
...
```sql
SELECT ALL COUNT ( * ) / - + 5 AS col1 FROM tab1 AS cor0
...
```sql
SELECT ALL + - 94 / + - 51 AS col2 FROM tab0 AS cor0

Expected: ["1","1","1"] but got ["1.843","1.843","1.843"]
```
...
```sql
SELECT + + col1 * 34 / col0 + + - 83 + + col0 * + 85 FROM tab1 AS cor0

Expected: ["4261","7144","7669"] but got ["4261.333","7144","7669.560"]
```
...
```sql
SELECT DISTINCT + - COUNT ( + CAST ( - + 62 AS REAL ) ) AS col2 FROM tab2 AS cor0
...
```sql
SELECT DISTINCT * FROM tab0 cor0 INNER JOIN tab1 AS cor1 ON NOT NULL IS NOT NULL
...
```sql
SELECT DISTINCT 80 / - col2 AS col0 FROM tab0 AS cor0 WHERE NOT CAST ( + 82 AS INTEGER ) * + + col0 * - col1 BETWEEN + + col0 AND - 24
...
```sql
SELECT DISTINCT - - 76 * + COUNT ( * ) AS col2 FROM tab1 WHERE NOT + 54 <= NULL

Expected: ["0"] but got ["228"]
```
...
Expected: ["NULL","NULL","NULL"] but got ["128","150","92"]
```
...
```sql
SELECT * FROM tab0 WHERE CAST ( NULL AS INTEGER ) + col0 IS NULL
...
```sql
SELECT + + CAST ( NULL AS INTEGER ) + - ( 70 ) AS col0, - col1 - + col1 FROM tab2 WHERE NOT 59 IN ( - col0, col2, - 3, - + ( col2 ) + + col2 + - 12 * + + col2 )
...
```sql
SELECT + ( 31 ) / - 53 - - - 55 + 45 AS col1

Expected: ["-10"] but got ["-10.585"]
```
...
```sql
SELECT DISTINCT COUNT ( * ) / - - 56 - - 37 + + + 41

Expected: ["78"] but got ["78.018"]
```
...
```sql
SELECT ALL + NULLIF ( - NULLIF ( - - 4, + + 68 ), + + 97 ) * 11 + NULLIF ( + CAST ( NULL AS INTEGER ), - ( COUNT ( * ) ) )

Expected: ["NULL"] but got ["-44"]
```
...
```sql
SELECT + 18 / - - 35 * - 79 * 34 AS col0

Expected: ["0"] but got ["-0.000"]
```
...
```sql
SELECT ALL - - 83 / ( + CAST ( - COUNT ( * ) AS INTEGER ) ) * - CAST ( 69 AS INTEGER ) + + COUNT ( * ) AS col2

Expected: ["5728"] but got ["NULL"]
```
...
```sql
SELECT ALL - ( - 59 ) + + ( + - ( 79 ) ) / 42 AS col0

Expected: ["58"] but got ["57.119"]
```
...
```sql
SELECT - CAST ( NULL AS REAL ) + + CAST ( + 31 AS INTEGER )
...
```sql
SELECT - 55 AS col2, 12 AS col2

Expected: ["-55","12"] but got ["12","12"]
```
...
```sql
SELECT + 25 AS col0, + 98 * 37 AS col0

Expected: ["25","3626"] but got ["3626","3626"]
```
...
```sql
SELECT - 30 * - - 58 + - + 24 * - - ( 35 ) + - 98 / - MIN ( ALL - 44 ) AS col1

Expected: ["-2582"] but got ["-2582.227"]
```
...
```sql
SELECT ALL - ( + 32 ) AS col2, 82 / - + 15 + 84

Expected: ["-32","79"] but got ["-32","78.533"]
```
...
```sql
SELECT DISTINCT + 5 + + CAST ( MAX ( + ( + CAST ( NULL AS INTEGER ) ) ) AS INTEGER ) AS col1
...
```sql
SELECT ALL COUNT ( * ) + - 80 * - ( - 20 ) AS col0, 97

Expected: ["-1599","97"] but got ["97","-1599"]
```
...
```sql
SELECT ALL + ( + COALESCE ( 52, CAST ( 60 AS INTEGER ) + + 27 ) ) / + 9 AS col2

Expected: ["5"] but got ["5.778"]
```
...
```sql
SELECT ALL COUNT ( * ) + + ( + + CAST ( NULL AS REAL ) ) * + + 28
...
Expected: ["58","79","87"] but got ["NULL"]
```
...
Expected: ["101","177","178"] but got ["NULL","NULL","NULL"]
```
...
Expected: ["225","8281","8464"] but got ["NULL","NULL","NULL"]
```
...
Expected: ["0","0","0"] but got ["-0.179","-0.232","-0.464"]
```
...
Expected: ["-2","-5","-7"] but got ["-2.885","-5.769","-7.500"]
```
...
Expected: ["1729","2475","6343"] but got ["1728.273","2475","6342.915"]
```
...
Expected: ["NULL","NULL","NULL"] but got ["128","160","6"]
```
...
Expected: ["1","2","5"] but got ["1.492","2.839","5.176"]
```
...
Expected: ["-1343","-213","-4602"] but got ["-1342.785","-212.571","-4601.244"]
```
...
Expected: ["67","67","67"] but got ["67.564","67.655","67.764"]
```
...
Total script time: 16359565.524ms
